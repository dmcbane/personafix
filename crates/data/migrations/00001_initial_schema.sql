...
CREATE TABLE IF NOT EXISTS weapons (
    ...
    recoil_comp TEXT NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS armor (
    id TEXT PRIMARY KEY,
    name TEXT NOT NULL,
    armor_value TEXT NOT NULL DEFAULT '0',
    availability TEXT NOT NULL,
    cost TEXT NOT NULL DEFAULT '0',
    edition TEXT NOT NULL CHECK (edition IN ('SR4', 'SR5')),
    source TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS augmentations (
    ...
    essence_cost TEXT NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS vehicles (
    ...
    acceleration TEXT NOT NULL DEFAULT '0',
    body TEXT NOT NULL DEFAULT '0',
    armor TEXT NOT NULL DEFAULT '0',
    pilot TEXT NOT NULL DEFAULT '0',
    sensor TEXT NOT NULL DEFAULT '0',
    availability TEXT NOT NULL,
    cost TEXT NOT NULL DEFAULT '0',
    edition TEXT NOT NULL CHECK (edition IN ('SR4', 'SR5')),
    source TEXT NOT NULL,
