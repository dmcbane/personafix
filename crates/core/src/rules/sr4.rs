...
impl CharacterRules for SR4Rules {
    ...
    fn apply_improvements(
        ...
        todo!("SR4 improvement resolution")
    }
    ...
    fn racial_limits(&self, metatype: Metatype) -> RacialLimits {
        ...
        match metatype {
            ...
            _ => todo!("SR4 racial limits for {metatype:?}"),
        }
    }
